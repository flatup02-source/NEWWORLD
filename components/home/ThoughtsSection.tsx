        ...
        <div className="bg-gradient-to-br from-white to-green-50 p-12 rounded-3xl shadow-2xl border-4 border-green-200">
          <div className="text-center mb-12">
            <OptimizedImage
              width={128}
              height={128}
              src="https://ik.imagekit.io/FLATUPGYM/_AIKA%20x.jpg"
              alt="女性オーナーあいか"
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-6">
            <p>
              「運動は苦手」「ジムは怖い」…そんな思い込みを、FLATUPGYMが覆します。
            </p>
            <p>
              私がこのスタジオを創ったのは、すべての人が自分らしく輝ける場所を作りたかったから。
              楽しく体を動かすことは、自分と向き合い、心も体も強くしてくれる素晴らしいものです。
            </p>
            <p>
              特に女性や子どもたちには、自分を守る力として、そして自信をつけるツールとして、運動の楽しさを知ってほしいのです。
            </p>
