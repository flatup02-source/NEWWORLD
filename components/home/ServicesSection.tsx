        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="aspect-[3/2] w-full overflow-hidden rounded-lg mb-4">
              <OptimizedImage src="/kick1.png" alt="キックボクシング" width={300} height={200} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={80} />
            </div>
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="aspect-[3/2] w-full overflow-hidden rounded-lg mb-4">
              <OptimizedImage src="/%E3%81%8D%E3%81%A3%E3%81%99%E3%82%99%E5%A5%B3%E3%81%AE%E5%AD%90%E3%82%AF%E3%83%A9%E3%82%B9TOP.png" alt="キッズクラス" width={300} height={200} className="w-full h-full object-cover" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={80} />
            </div>
