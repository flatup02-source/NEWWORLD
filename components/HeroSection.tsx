      ...
      <div className="relative z-20 flex flex-col items-center justify-center text-white text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white mb-16 leading-[0.85] drop-shadow-2xl tracking-wider">
            <span className="text-white text-3xl sm:text-5xl md:text-6xl font-bold mb-8 drop-shadow-lg tracking-wide block">
              世界一優しい格闘技ジム FLATUPGYM
            </span>
            <span className="text-pink-500 animate-bounce mb-8 drop-shadow-2xl transform hover:scale-105 transition-transform duration-500 cursor-default inline-block">
            ...
            <span className="text-yellow-400 text-shadow-xl mb-12 drop-shadow-2xl transform hover:scale-105 transition-transform duration-500 cursor-default inline-block">
