        ...
        <div className="flex flex-col space-y-2 px-4">
          {navLinks.map(link => (
            <NavLink
              ...
              {...link}
              onClick={closeMenu}
              className={`px-4 py-4 rounded-lg hover:bg-pink-50 transform hover:translate-x-2 transition-transform duration-300 ${link.href === '/schedule' ? 'bg-purple-100 text-purple-700 font-extrabold text-lg' : ''
                }`}
            />
          ))}
