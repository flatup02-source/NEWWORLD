      ...
      <nav className="px-4 sm:px-6 lg:px-8 font-sans-japanese">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center">
            <Link
              href="/line"
              className="group relative bg-sakura-pink hover:bg-sakura-hover text-white px-6 py-3 rounded-full transition-all duration-300 whitespace-nowrap font-bold text-base shadow-lg transform hover:scale-105"
            >
