    ...
    return (
        <>
            ...
            <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
                ...
                <Link
                    href="/line"
                    className="w-16 h-16 rounded-full bg-[#00C300] hover:bg-[#00B000] text-white flex items-center justify-center shadow-lg transform hover:scale-110 transition-all duration-300"
                    aria-label="LINE"
                >
