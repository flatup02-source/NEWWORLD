      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <OptimizedImage src="/kick1.png" alt="キックボクシング" width={300} height={200} className="mx-auto mb-4 rounded-lg" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={80} />
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <OptimizedImage src="https://ik.imagekit.io/FLATUPGYM/bjj2.png?updatedAt=1756897178742" alt="ブラジリアン柔術" width={300} height={200} className="mx-auto mb-4 rounded-lg" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={80} />
          ...
          <div className="bg-gray-50 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <OptimizedImage src="/%E3%81%8D%E3%81%A3%E3%81%99%E3%82%99%E5%A5%B3%E3%81%AE%E5%AD%90%E3%82%AF%E3%83%A9%E3%82%B9TOP.png" alt="キッズクラス" width={300} height={200} className="mx-auto mb-4 rounded-lg" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" quality={80} />
